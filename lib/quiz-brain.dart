import 'package:quizflutterapp/question.dart';

class QuizBrain {
  //Counter for the questions, when a button is pressd, the count number increment
  int _questionsCount = 0;

  //List of questions we need. The Class question is imported
  ...
  void nextQuestion() {
    if (_questionsCount < _questions.length - 1) {
      _questionsCount++;
    }
  }
  ...
  String getQuestionText() {
    return _questions[_questionsCount].question;
  }

  bool getQuestionAnswer() {
    return _questions[_questionsCount].answer;
  }
}
